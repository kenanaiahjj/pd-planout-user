import svgPaths from "./svg-d7vpryk19y";
...
function Frame17() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Frame">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[1.4] not-italic relative shrink-0 text-[#535862] text-[20px] tracking-[-0.4px] w-full whitespace-pre-wrap">Thank you for your review!</p>
    </div>
  );
}
...
function Frame19() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start leading-[1.4] not-italic relative shrink-0 text-[#535862] text-[16px] tracking-[-0.48px] w-full whitespace-pre-wrap" data-name="Frame">
      <p className="font-['Inter:Medium',sans-serif] font-medium relative shrink-0 w-full">Your feedback helps us improve future events.</p>
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold relative shrink-0 w-full">Your certificate is ready to download.</p>
    </div>
  );
}
...
function Frame20() {
  return (
    <div className="absolute bg-[#e9f6f4] content-stretch flex items-center justify-between left-0 overflow-clip px-[16px] py-[12px] top-0 w-[400px]" data-name="Frame">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[1.4] not-italic relative shrink-0 text-[#177564] text-[20px] tracking-[-0.4px]">Review Submitted</p>
      <Frame21 />
    </div>
  );
}
    ...
    <div className="flex-[1_0_0] min-h-px min-w-px relative rounded-[8px]" data-name="_Button base" style={{ backgroundImage: "url(\'data:image/svg+xml;utf8,<svg viewBox=\\'0 0 352 44\\' xmlns=\\'http://www.w3.org/2000/svg\\' preserveAspectRatio=\\'none\\'><rect x=\\'0\\' y=\\'0\\' height=\\'100%\\' width=\\'100%\\' fill=\\'url(%23grad)\\' opacity=\\'0.20000000298023224\\'/><defs><radialGradient id=\\'grad\\' gradientUnits=\\'userSpaceOnUse\\' cx=\\'0\\' cy=\\'0\\' r=\\'10\\' gradientTransform=\\'matrix(5.1818e-7 -2.2 17.6 6.4772e-8 176 22)\\'><stop stop-color=\\'rgba(255,255,255,0)\\' offset=\\'0\\'/><stop stop-color=\\'rgba(255,255,255,1)\\' offset=\\'1\\'/></radialGradient></defs></svg>\'), linear-gradient(90deg, rgb(60, 212, 185) 0%, rgb(23, 117, 100) 100%)" }}>
      <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center justify-center px-[18px] py-[10px] relative w-full">
          <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] not-italic relative shrink-0 text-[16px] text-white">Download Certificate</p>
        </div>
      </div>
...
function Frame23() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="Frame">
      <ModalActions />
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[1.2] not-italic relative shrink-0 text-[10px] text-black tracking-[-0.2px]">Save your achievement certificate to your device</p>
    </div>
  );
}
...
export default function HomeNotificationSubmitAReviewDownloadCertificate() {
  return (
    <div className="bg-white relative size-full" data-name="Home // Notification // Submit A Review // Download Certificate">
      <div className="absolute left-[-198px] size-[846px] top-[-266px]" data-name="Ellipse">
        <div className="absolute inset-[-14.18%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1086 1086">
            <g filter="url(#filter0_f_34_6281)" id="Ellipse">
              <circle cx="543" cy="543" fill="var(--fill-0, #F3FDFB)" r="423" />
            </g>
            <defs>
              <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="1086" id="filter0_f_34_6281" width="1086" x="0" y="0">
                <feFlood floodOpacity="0" result="BackgroundImageFix" />
                <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
                <feGaussianBlur result="effect1_foregroundBlur_34_6281" stdDeviation="60" />
              </filter>
            </defs>
          </svg>
        </div>
      ...
      <div className="absolute left-[calc(41.67%+15px)] size-[846px] top-[418px]" data-name="Ellipse">
        <div className="absolute inset-[-14.18%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1086 1086">
            <g filter="url(#filter0_f_34_6273)" id="Ellipse">
              <circle cx="543" cy="543" fill="var(--fill-0, #F3FDFB)" r="423" />
            </g>
            <defs>
              <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="1086" id="filter0_f_34_6273" width="1086" x="0" y="0">
                <feFlood floodOpacity="0" result="BackgroundImageFix" />
                <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
                <feGaussianBlur result="effect1_foregroundBlur_34_6273" stdDeviation="60" />
              </filter>
            </defs>
          </svg>
        </div>
      ...
      <div className="absolute h-[200px] left-[calc(83.33%+21px)] top-[-37px] w-[230px]" data-name="Ellipse">
        <div className="absolute inset-[-75%_-65.22%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 530 500">
            <g filter="url(#filter0_f_34_6271)" id="Ellipse">
              <ellipse cx="265" cy="250" fill="var(--fill-0, #F4FDFB)" rx="115" ry="100" />
            </g>
            <defs>
              <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="500" id="filter0_f_34_6271" width="530" x="0" y="0">
                <feFlood floodOpacity="0" result="BackgroundImageFix" />
                <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
                <feGaussianBlur result="effect1_foregroundBlur_34_6271" stdDeviation="75" />
              </filter>
            </defs>
          </svg>
        </div>
